...
const Checkout = () => {
  ...
  const handleChange = (e) => {
    ...
    if (
      paymentDetails.fullName.length > 0 &&
      paymentDetails.address.length > 0 &&
      paymentDetails.phone.length > 0 &&
      selectedOption
    ) {
      setDataCheck(true);
    }
  ...
  return (
    <Box w="100%">
      ...
      >
        ...
        <Box
          w="100%"
          h={{ base: "auto", md: "350px", sm: "300px", xs: "250px" }}
        >
          <Grid
            w={{ base: "85%", md: "85%" }}
            margin="auto"
            padding={{ base: "1rem", sm: "0.5rem" }}
          ...
          >
            ...
            >
              ...
              <Box w="100%" padding="0.5rem" borderColor="gray.200">
                <Text
                  ...
                  textAlign="center"
                  fontWeight="bold"
                  lineHeight={{ base: "2rem", md: "2rem", sm: "1.6rem" }}
                  fontSize={{ base: "24px", md: "24px", sm: "22px" }}
                >
                  Order Summary
                </Text>
            ...
            <GridItem
              ...
              border="1px solid"
              borderColor="rgb(233,233,233)"
              padding={{ base: "1rem", md: "1rem", sm: "0.8rem" }}
            >
        ...
        <Modal onClose={onClose} isOpen={isOpen} isCentered>
          ...
          <ModalContent>
            ...
            <ModalFooter>
              <Link to="/">
                <Button colorScheme="blue" mr={1} onClick={handleRemoveItem}>
                  Confirm
                </Button>
              </Link>
            </ModalFooter>
